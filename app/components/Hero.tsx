...
const Hero = () => {
  return (
    <div className='lg:fixed lg:z-[999] mt-32 lg:w-1/2 flex flex-col h-[40rem] gap-6 lg:justify-between'>
      <div className='flex flex-col gap-4'>
        <p className='text-6xl font-bold'>Adeoluwa</p>
        <p className='text-[22px] font-semibold'>Software Engineer</p>
        <p className='text-sm text-[#949495] mt-4'>
